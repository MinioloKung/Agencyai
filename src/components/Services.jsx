...
const Services = () => {
    ...
    const servicesData = [
        {
          title: 'Advertising',
          description: 'We turn your bold ideas into powerful digital solutions that connect, engage...',
  ...
  return (
    ...
    sm:px-12 lg:px-24 xl:px-40 pt-16 md:pt-24 text-gray-700 dark:text-white'>
